...
(() => {
    ...
    return /* @__PURE__ */ jsx(AlertModal, {
      ...
      extraContent: /* @__PURE__ */ jsxs(Stack, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native16.ScrollView, {
            horizontal: true,
  ...
  function AddonPage({ CardComponent, ...props }) {
    ...
    var headerElement = /* @__PURE__ */ jsxs(import_react_native16.View, {
      style: {
        paddingBottom: 8
      },
      children: [
        settings.safeMode?.enabled && /* @__PURE__ */ jsxs(import_react_native16.View, {
          style: {
            marginBottom: 10
          },
          children: [
    ...
    return /* @__PURE__ */ jsxs(ErrorBoundary, {
      children: [
        /* @__PURE__ */ jsx(FlashList, {
          ...
          ListEmptyComponent: () => /* @__PURE__ */ jsxs(import_react_native16.View, {
            style: {
              gap: 12,
              padding: 12,
              alignItems: "center"
  ...
  var import_fuzzysort, import_react3, import_react_native16, showSimpleActionSheet, hideActionSheet;
...
//# sourceURL=${plugin.id}`;
  ...
  var import_react_native17, showSimpleActionSheet2, handleClick, getChannelId, getChannel, url_default;
  var init_url = __esm({
    "src/core/plugins/quickinstall/url.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
        ...
        patches3.push(instead("handleClick", handleClick, function(args, orig) {
          return _async_to_generator(function* () {
            ...
            showConfirmationAlert({
              ...
              onConfirmSecondary: () => import_react_native17.Linking.openURL(url2)
            });
          }).call(this);
        }));
        return () => patches3.forEach((p) => p());
  ...
  function PluginCard({ result, item: plugin }) {
    ...
    var [, forceUpdate] = (0, import_react4.useReducer)((value) => value + 1, 0);
  ...
  var import_chroma_js4, import_react4, import_react_native18, CardContext, useCardContext;
  ...
  function PluginInfoActionSheet({ plugin, navigation: navigation2 }) {
    ...
    var isUrlPlugin = plugin.id.includes("/");
    var isInternalPlugin = !isUrlPlugin && isCorePlugin(plugin.id);
    var getRepositoryUrl = () => {
      var manifest = registeredPlugins.get(plugin.id);
      return manifest?.parentRepository;
    };
    var copyPluginUrl = () => {
      var url2 = isUrlPlugin ? plugin.id : getRepositoryUrl() ?? plugin.id;
      clipboard.setString(url2);
      showToast("URL copiada", findAssetId("toast_copy_link"));
    };
    var updatePlugin = () => _async_to_generator(function* () {
      setLoading(true);
      try {
        if (isUrlPlugin) {
          var current = VdPluginManager.plugins[plugin.id];
          var wasEnabled = current?.enabled ?? false;
          if (wasEnabled)
          ...
          if (!repoUrl)
            throw new Error("Fonte do plugin n\xE3o encontrada");
          if (plugin.isEnabled()) {
            yield refreshPlugin(plugin.id, repoUrl);
          } else {
            yield updateAndWritePlugin(repoUrl, plugin.id, true);
          }
        }
        showToast("Plugin atualizado", findAssetId("Check"));
      } catch (e) {
        showToast(`Falha ao atualizar: ${e instanceof Error ? e.message : String(e)}`, findAssetId("Small"));
      } finally {
        setLoading(false);
      }
    })();
    var clearPluginData = () => {
      showConfirmationAlert({
        title: "Limpar dados",
        content: "Isso apaga as configura\xE7\xF5es e os dados salvos deste plugin. Deseja continuar?",
        confirmText: "Limpar",
        confirmColor: "red",
        cancelText: "Cancelar",
        onConfirm: () => _async_to_generator(function* () {
          ...
          try {
            ...
            showToast("N\xE3o foi poss\xEDvel limpar os dados", findAssetId("Small"));
          }
        })()
      });
    };
    var removePlugin = () => {
      if (isInternalPlugin) {
        showToast("Plugins internos n\xE3o podem ser removidos", findAssetId("Small"));
        return;
      }
      showConfirmationAlert({
        ...
        onConfirm: () => _async_to_generator(function* () {
          ...
          try {
            if (isUrlPlugin) {
              ...
              yield uninstallPlugin(plugin.id);
            }
            showToast("Plugin removido", findAssetId("Check"));
          } catch (e) {
            showToast(`Falha ao remover: ${e instanceof Error ? e.message : String(e)}`, findAssetId("Small"));
          }
        })()
      });
    };
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(import_react_native20.View, {
            ...
            children: [
              ...
              !isInternalPlugin && /* @__PURE__ */ jsx(PluginInfoIconButton, {
                label: "Atualizar",
                variant: "secondary",
                icon: findAssetId("RetryIcon"),
  ...
  var import_react5, import_react_native20;
  ...
  function PluginPage(props) {
    ...
    return /* @__PURE__ */ jsx(AddonPage, {
      ...
      sortOptions: {
        "Nome (A-Z)": (a, b3) => a.name.localeCompare(b3.name),
        "Nome (Z-A)": (a, b3) => b3.name.localeCompare(a.name)
      },
      safeModeHint: {
  ...
  function Plugins() {
    return /* @__PURE__ */ jsx(PluginPage, {
      useItems: () => {
        ...
        var urlPlugins = Object.values(VdPluginManager.plugins).map(unifyVdPlugin);
        var repositoryPlugins = [
          ...registeredPlugins.values()
        ].filter((p) => isPluginInstalled(p.id) && !isCorePlugin(p.id)).map(unifyBunnyPlugin);
        return [
          ...internalPlugins,
      ...
      installAction: {
        ...
        fetchFn: (url2) => _async_to_generator(function* () {
          var pluginUrl = url2.trim();
          if (!/^https?:\/\//i.test(pluginUrl)) {
            throw new Error("Use uma URL come\xE7ando com http:// ou https://");
          }
          openAlert2("plugin-install-confirmation", /* @__PURE__ */ jsx(AlertModal3, {
            title: "Instalar plugin?",
            content: "Plugins externos executam c\xF3digo dentro do Discord. Instale apenas plugins de fontes em que voc\xEA confia.",
              ...
              children: [
                /* @__PURE__ */ jsx(AlertActionButton3, {
                  ...
                  onPress: () => _async_to_generator(function* () {
                    try {
                      yield VdPluginManager.installPlugin(pluginUrl);
                      showToast("Plugin instalado", findAssetId("Check"));
                    } catch (e) {
                      openAlert2("plugin-install-failed", /* @__PURE__ */ jsx(AlertModal3, {
                        title: "Falha ao instalar",
                        content: "N\xE3o foi poss\xEDvel instalar esse plugin.",
                        extraContent: /* @__PURE__ */ jsx(Card, {
                          children: /* @__PURE__ */ jsx(Text, {
                            variant: "text-md/normal",
  ...
  var openAlert2, AlertModal3, AlertActions2, AlertActionButton3;
  var init_Plugins = __esm({
    "src/core/ui/settings/pages/Plugins/index.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
    ...
    return /* @__PURE__ */ jsxs(import_react_native21.View, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(FlashList, {
          ...
          ListHeaderComponent: mode === "plugins" ? /* @__PURE__ */ jsx(import_react_native21.View, {
            style: {
              paddingVertical: 6,
              paddingHorizontal: 8
            },
          ...
          //@ts-ignore
          renderItem: ({ item: addon }) => /* @__PURE__ */ jsx(import_react_native21.View, {
            style: {
              paddingVertical: 6,
              paddingHorizontal: 8
            },
  ...
  var import_react_native21, showSimpleActionSheet3, hideActionSheet2, PLUGIN_URL, THEME_URL, Sort;
  ...
  function AssetDisplay({ asset }) {
    return /* @__PURE__ */ jsx(TableRow, {
      ...
      icon: displayable.has(asset.type) ? /* @__PURE__ */ jsx(import_react_native22.Image, {
        source: asset.id,
        style: {
          width: 32,
          height: 32
      ...
      onPress: () => openAlert3("revenge-asset-display-details", /* @__PURE__ */ jsx(AlertModal4, {
        title: asset.name,
        content: `Index: ${asset.id}
Module ID: ${asset.moduleId}
Type: ${asset.type}`,
        extraContent: displayable.has(asset.type) ? /* @__PURE__ */ jsx(import_react_native22.Image, {
          resizeMode: "contain",
          source: asset.id,
          style: {
            flex: 1,
  ...
  var import_react_native22, openAlert3, AlertModal4, AlertActionButton4, displayable, iconMap, copyToClipboard;
  ...
  function AssetBrowser() {
    ...
    var all = (0, import_react7.useMemo)(() => Array.from(iterateAssets()), []);
    var filteredData = (0, import_react7.useMemo)(() => {
          ...
          /* @__PURE__ */ jsxs(import_react_native23.View, {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(import_react_native23.TouchableOpacity, {
                ...
                children: /* @__PURE__ */ jsx(import_react_native23.Image, {
                  style: {
                    width: 20,
                    height: 20
                  },
  ...
  var import_react7, import_react_native23, displayable2;
  ...
  function Developer() {
    ...
    var [isDebuggerConnected, setIsDebuggerConnected] = (0, import_react8.useState)(isConnectedToDebugger2());
            ...
            /* @__PURE__ */ jsxs(TableRowGroup, {
              ...
              children: [
                /* @__PURE__ */ jsx(TableRow, {
                  ...
                  onPress: () => {
                    openAlert4("pupu-clear-bundle-reload-confirmation", /* @__PURE__ */ jsx(AlertModal5, {
                      ...
                      actions: /* @__PURE__ */ jsxs(Stack, {
                        children: [
                          /* @__PURE__ */ jsx(AlertActionButton5, {
                            text: Strings.RELOAD,
                            variant: "destructive",
                            onPress: () => import_react_native24.NativeModules.BundleUpdaterManager.reload()
                          }),
                          /* @__PURE__ */ jsx(AlertActionButton5, {
                            text: Strings.CANCEL,
                            variant: "secondary"
